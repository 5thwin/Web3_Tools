  ...
  return (
    <div className='max-w-screen-lg h-[800px] mx-auto pt-14 flex flex-col justify-center' >
      ...
      <div className='flex w-1/2 mx-auto justify-around'>
        <button onClick={() => { changeOwner('0xe53C07d063F4d9aB3D6687e887Bf6ccDaca6F70a') }}>User1</button>
        <button onClick={() => { changeOwner('0x0097b9cFE64455EED479292671A1121F502bc954') }}>User2</button>
        <button onClick={() => { changeOwner('0x3535a04cA0D90F59147B779F4B9355C4d172F1c9') }}>User3</button>
      </div>
